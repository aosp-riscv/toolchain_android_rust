...
LD_RPATH_BUILDTIME: str = '-L' + LLVM_CXX_RUNTIME_PATH.as_posix() + ' -rpath ' + LLVM_CXX_RUNTIME_PATH.as_posix()

CXX_RPATH_BUILDTIME: str = (
    '-L' + LLVM_CXX_RUNTIME_PATH.as_posix() +
...
CXX_MACOSX_FLAGS: str = '-mmacosx-version-min=10.14' if build_platform.system() == 'darwin' else ''

CXX_LINKER_FLAGS = CXX_RPATH_BUILDTIME + ' ' + CXX_RPATH_RUNTIME + ' ' + CXX_MACOSX_FLAGS
...
def configure():
    ...
    instantiate_template_file(
        ...
        llvm_ldflags=LD_RPATH_BUILDTIME + " -stdlib=libc++",
