...
LD_RPATH_BUILDTIME:  str = LLVM_LIBPATH_ARGUMENT + ' -rpath '     + LLVM_CXX_RUNTIME_PATH.as_posix()
CXX_RPATH_BUILDTIME: str = LLVM_LIBPATH_ARGUMENT + ' -Wl,-rpath,' + LLVM_CXX_RUNTIME_PATH.as_posix()
...
def configure():
    ...
    instantiate_template_file(
        ...
        llvm_ldflags=LLVM_LIBPATH_ARGUMENT,
