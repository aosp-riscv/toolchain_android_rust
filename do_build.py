...
LLVM_BUILD_PATHS_OF_INTERST: list[str] = [
    'build.ninja',
    'cmake',
    'CMakeCache.txt',
    'CMakeFiles',
...
def main():
    ...
    env['LDFLAGS'] = config.CXX_LINKER_FLAGS_BUILDTIME
    ...
    if ec != 0:
        ...
        subprocess.check_call(['tar', 'czf', tarball_path] + LLVM_BUILD_PATHS_OF_INTERST,
            cwd=LLVM_BUILD_PATH)
        sys.exit(ec)
