...
def configure():
    ...
    macosx_flags:          str = ''
    host_ld_selector:      str = '-fuse-ld=lld' if build_platform.system() == 'linux' else ''
    host_bin_search:       str = ('-B' + GCC_TOOLCHAIN_PATH.as_posix()) if build_platform.system() == 'linux' else ''
    ...
    host_rpath_runtime:    str = '-Wl,-rpath,' + (
        '$ORIGIN/../lib64' if build_platform.system() == 'linux' else '@loader_path/../lib64')
