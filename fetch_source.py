...
def parse_args() -> argparse.ArgumentParser:
  ...
  parser.add_argument("-b", "--beta", dest="beta", action="store_true", default=False, help="fetch the beta archive")
...
def main() -> None:
  ...
  print("\nCreating branch")
  exec_rustc_src_command(COMMAND_REPO % (args.rust_version + ("-beta" if args.beta else "")), "Error creating repo for source update")
